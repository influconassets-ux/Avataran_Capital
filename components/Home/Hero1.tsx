      ...
      <div className="relative min-h-full my-10 md:mt-0 h-fit w-full flex flex-row justify-center items-center gap-0 md:gap-0 z-[2]">
        <div className="flex flex-col h-full gap-[8vh] sm:gap-[14vh] justify-evenly items-center">
          <img
            src="/star.png"
            alt="Star"
            className="w-3 h-3 md:w-4 md:h-4 aspect-square"
          />
          <div className="flex flex-col md:flex-row gap-1 items-center font-semibold text-[12px] sm:text-[14px] md:text-[16px] text-[#1a1a1a]">
            <p className="text-[20px] sm:text-[28px] md:text-[36px] sans text-[#0F6089] tracking-[-1]">
              20+
            </p>
            <p>
              Locations <br />
        ...
        />
        <div className="flex flex-col-reverse h-full gap-[8vh] sm:gap-[14vh] justify-evenly items-center">
          <img
            src="/star.png"
            alt="Star"
            className="w-3 h-3 md:w-4 md:h-4 aspect-square"
